        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">새글 등록 </h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                             <!-- 본문 들어갈 자리 -->
                      <form id="updateform" action="insertBoard.do" method="post" enctype="multipart/form-data">
                       ...
                       <div class="form-group">
                         ...
                         <input type="text" class="form-control" id="formwriter" name="writer" value=<%=session.getAttribute("username") %> readonly />
                       </div>
                       
                       <div class="form-group">
                         <label for="formcontent">내  용</label>
                         <textarea class="form-control" id="formcontent" name="content" rows="5">${board.getContent()}</textarea>
                       </div>
                       <div class="form-group">
                         <label for="formfile">파일첨부</label>
                         <input name="uploadFile" class="form-control form-control-lg" id="formfile" type="file" accept=".jpg,.png">
                       </div>
