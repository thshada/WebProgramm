			...
			<div class="card-body">
				<form id="loginform" action="login.do" method="post">
					<div class="input-group form-group">
						...
						<input type="text" name="id" value="${userVO.id }" class="form-control" placeholder="username"
						id="usr_id">
					...
					<div class="input-group form-group">
						...
						<input type="password" name="password" value="${userVO.password }" class="form-control" placeholder="password"
						id="usr_pass">
					</div>
